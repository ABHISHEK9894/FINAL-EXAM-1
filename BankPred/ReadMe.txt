...
git branch -M main
git remote add origin https://github.com/ABHISHEK9894/FINAL-EXAM-1.git
...
>>docker run -d -p 5000:5000 --name TERM_PLAN <IMAGE_NAME:VERSION>
...
>>docker tag bankapp:v5 xxxxxxxx806.dkr.ecr.us-east-1.amazonaws.com/myrepo
